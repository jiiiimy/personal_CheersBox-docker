...
<div class="all-container">
	<div class="container -theme" id="addTheme">
		<div class="contents -theme">
			<form class="container -form -new" method="post" action="{{ url('/host/createpage') }}" enctype='multipart/form-data'>
				@csrf
				@method('post')
				<div class="contents -form">
					...
					<input class="input-title" id="formPageTitle" type="text" name="page-title" placeholder="メインメッセージを書こう！" value="{{ old('page-title') }}">
						...
						<div class="box -input-file">
							...
							<label class="input-file-toucharea" id="input-file-toucharea" for="formPageThumbnail">
								<p>
									...
									<span class="-text">画像を追加できるよ！<br>(しなくてもOK！)</span>
								</p>
							</label>
						</div>
					</div>
						...
						<div class="contents -message-card">
							<div class="card">
								<p class="-text">これはサンプルです。
									寄せ書きのメッセージがこのようなカードで表示されます。デザインを選んで見え方を確認してみてください！</p>
								<p class="-by">運営より！</p>
							</div>
						</div>
					</div>
					<div class="container -select-theme ">
						<div class="contents -select-theme">
							<div class="area -select-theme">
								<p class="-title">ページのデザインを選ぼう！</p>
								<ul class="-list">
									<li class="theme chee">
										<input type="radio" name="theme" class="theme-radio-input" id="theme-radio-chee" value="0" @if(old('theme')==0) checked @elseif(!old('theme')) checked @endif>
									...
									<li class="theme mono">
										<input type="radio" name="theme" class="theme-radio-input" id="theme-radio-mono" value="1" @if(old('theme')==1) checked @endif>
									...
									<li class="theme natu">
										<input type="radio" name="theme" class="theme-radio-input" id="theme-radio-natu" value="2" @if(old('theme')==2) checked @endif>
									...
									<li class="theme city">
										<input type="radio" name="theme" class="theme-radio-input" id="theme-radio-city" value="3" @if(old('theme')==3) checked @endif>
					...
					<button class="btn -submit" type="submit"><span>保存して次へ</span></button>
					<a class="link -option" target="_blank" rel="noopener" href="{{ url('/userpolicy')}}">利用規約を確認してね！</a>
				</div>
			</form>
		</div>
	</div>
